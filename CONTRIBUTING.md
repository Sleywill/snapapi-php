# Contributing to the SnapAPI PHP SDK
...
Use the [Bug Report template](https://github.com/Sleywill/snapapi-php/issues/new?template=bug_report.md).
...
Use the [Feature Request template](https://github.com/Sleywill/snapapi-php/issues/new?template=feature_request.md).
...
Open a [Discussion](https://github.com/Sleywill/snapapi-php/discussions) or email support@snapapi.pics.
